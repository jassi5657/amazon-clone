          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value={"top1"}>top</MenuItem>

                
                <MenuItem value={"tshirtMen"}>Men Tshirt</MenuItem>
                ...
                <MenuItem value={"homedeco"}> home deco</MenuItem>
                <MenuItem value={"homestore"}> home store</MenuItem>
                <MenuItem value={"appleWala"}> Apple</MenuItem>

                <MenuItem value={"allItems"}> All Item</MenuItem>
                <MenuItem value={"washing"}> homeApp</MenuItem>
                <MenuItem value={"microOven"}> microwave</MenuItem>
                <MenuItem value={"refrigerators"}> Fridge</MenuItem>
                <MenuItem value={"top1"}> top</MenuItem>
                ...
                {/* posting data in db with all random values  */}
