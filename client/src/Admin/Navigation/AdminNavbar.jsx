    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(0, 0, 22)' }}>
        <Toolbar>
          ...
          {/* <Avatar alt="Zosh" src="http://pngimg.com/uploads/amazon/amazon_PNG11.png" style={{width:"50px"}} /> */}
          <img src="http://pngimg.com/uploads/amazon/amazon_PNG11.png" style={{width:"100px", marginTop:"10px"}} />
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
