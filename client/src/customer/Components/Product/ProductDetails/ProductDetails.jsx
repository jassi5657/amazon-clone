...
{customersProduct.product?.discountedPrice < 500? (
  <p>No EMI plans available for this price</p>
) : (
  <>
    <Emi>₹{customersProduct.product?.price/12 } <span>/month (24 months) </span> </Emi>
  <EmiPlans>
    with <b>EMI</b>  on your SBI Credit Card <span> All EMI Plans </span>
  </EmiPlans>
  </>
)}
    ...
    <Price>-38% <span>₹{customersProduct.product?.discountedPrice}</span></Price>
    <MRP>M.R.P.: <span>₹{customersProduct.product?.price}</span></MRP>
    <FullFill>
...
<Price1>
<p>₹</p>
    <h3>{customersProduct.product?.discountedPrice} <sup className='sup'>00</sup> </h3>

</Price1>
<Image>
    <img src={fullfill} alt="" />
</Image>
<Delivery>FREE delivery <span>Thursday, {currentDay+2} <br /> {currentMonth}.</span> Details</Delivery>
...
<form className="mt-10" onSubmit={handleSubmit}>
        ...
        <Button
          variant="contained"
          type="submit"
          sx={{ padding: ".8rem 2rem", marginTop: "2rem", backgroundColor:"rgb(255,216,20)", color:"black", borderRadius:"50px", width:"200px" , height:"35px" }}
        >
          Add To Cart
        </Button>
      </form>
...
<Description>
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse asperiores quidem voluptate quibusdam vitae, eum iure iste incidunt architecto fuga, et, ipsa maiores! Sed nesciunt mollitia nostrum, perferendis vel consequuntur, sit quasi eaque culpa perspiciatis illum est, praesentium vero id? Nam assumenda unde, voluptas, quasi consequatur numquam libero laborum dolores porro iste autem ab quidem impedit suscipit quas? Voluptatem voluptatibus ut corporis possimus distinctio. Eveniet, ipsum. Deserunt neque ad corporis blanditiis incidunt? Dignissimos ab quas aliquam eius quos rerum exercitationem ipsa doloremque hic repellat sunt numquam mollitia saepe alias quibusdam, eveniet dicta error nemo deserunt quo culpa. Sapiente, tenetur ea?</p>
</Description>
<br />
<br />
<hr />
