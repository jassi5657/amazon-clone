...
import OtherProducts from "../customer/Components/otherProducts/OtherProducts";
...
import MobileProducts from "../customer/Components/otherProducts/MobileProducts";
  ...
  return (
    ...
    {showNavigation && <Navigation />}
     ...
     <Routes>
        ...
        <Route path="/otherproducts" element={<OtherProducts />}></Route>
        <Route path="/mixcard" element={<MixCard />}></Route>
        <Route path="/main" element={<MainCard />}></Route>
        <Route path="/mobileProduct" element={<MobileProducts />}></Route>
        <Route path="/mobileFeatured" element={<FooterProduct />}></Route>
